...
export function FinalCTA() {
  return (
    <SectionReveal className="px-4 pb-24 pt-10 sm:px-6">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-lg border border-white/10 bg-[var(--surface-2)]/86 p-6 text-center shadow-[0_0_100px_rgb(var(--signal-rgb)/0.18)] backdrop-blur-xl sm:p-10">
        <div className="absolute inset-0 bg-[linear-gradient(120deg,transparent,rgb(var(--signal-rgb)/0.08),transparent)]" />
        <div className="relative mx-auto mb-6 h-24 max-w-lg rounded-full bg-[radial-gradient(circle,rgb(var(--signal-rgb)/0.34),rgb(var(--signal-rgb)/0.18),transparent_70%)] blur-xl" />
