...
HERMES_WEBINAR_CARD_TEXT = """Живой разбор с Андреем

3 августа в 19:00 МСК

На эфире Андрей вживую покажет:

— как выбрать подходящее ИИ-решение и нишу;
— где найти потенциальных клиентов;
— как отобрать подходящие контакты;
— что написать первым сообщением;
— как прозрачно перейти от полезного решения к РКО, когда у бизнеса есть реальная потребность.

Продолжительность основной части — 45 минут."""

HERMES_WEBINAR_REGISTERED_TEXT = """Вы записаны.

Главный вебинар пройдёт 3 августа в 19:00 МСК.

Андрей покажет полный путь:
ИИ-решение → выбор ниши → поиск потенциальных клиентов → первые персональные сообщения → следующий шаг в диалоге.

Перед началом я пришлю ссылку сюда."""
...
HERMES_WEBINAR_ALREADY_REGISTERED_TEXT = """Вы уже записаны на этот вебинар."""
