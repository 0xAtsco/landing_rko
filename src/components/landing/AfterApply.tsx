  ...
  return (
    <SectionReveal className="px-4 py-16 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <div className="rounded-lg border border-signal/14 bg-[var(--surface-2)]/76 p-5 shadow-[0_24px_90px_rgba(0,0,0,0.22)] backdrop-blur-xl sm:p-8">
          <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {afterApplySteps.map((step, index) => (
                ...
                >
                  <div aria-hidden="true" className="absolute right-3 top-3 font-mono text-4xl font-semibold text-signal/10">
                    {index + 1}
                  </div>
