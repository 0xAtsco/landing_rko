    ...
    <section className="relative isolate min-h-[88svh] overflow-hidden px-4 pb-4 pt-24 sm:px-6 sm:pb-8 lg:pt-28">
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[0.96fr_1.04fr]">
        <div className="relative z-10 min-w-0 max-w-full text-center lg:text-left">
          ...
          <div className="mx-auto mt-5 max-w-2xl rounded-lg border border-cyan-200/18 bg-[#071a33]/72 p-2 shadow-[inset_0_0_34px_rgba(34,211,238,0.08)] md:backdrop-blur-md lg:mx-0">
...
function HeroVisual() {
  return (
    <div className="absolute inset-0 overflow-hidden rounded-[1.6rem] border border-cyan-200/18 bg-[#041326]/82 p-5 shadow-[0_34px_120px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-xl">
      ...
      <div className="relative z-10 mt-5 h-[calc(100%-76px)] min-h-[420px] overflow-hidden rounded-[1.25rem] border border-cyan-200/12 bg-black/16">
...
function HeroMobileVisual() {
  return (
    <div className="mx-auto mt-5 max-w-sm overflow-hidden rounded-lg border border-cyan-200/18 bg-[#06172e]/78 p-3 shadow-[0_18px_56px_rgba(34,211,238,0.1)] backdrop-blur-md">
      <div className="grid grid-cols-[0.76fr_1fr] gap-3">
        <div className="relative grid min-h-28 place-items-center overflow-hidden rounded-md border border-cyan-200/14 bg-black/20">
