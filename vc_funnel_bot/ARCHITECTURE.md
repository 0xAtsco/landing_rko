...
В текущей версии нет LLM, распознавания голоса, CRM, отдельной
веб-регистрации и календарной интеграции. Подтверждение регистрации и все
напоминания приходят пользователю в Telegram.
...
- Нет календарной интеграции или бронирования слотов.
- Нет LLM, voice и STT.
