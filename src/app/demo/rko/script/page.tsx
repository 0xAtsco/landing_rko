...
const steps = [
  ...
  "Показать streaming-ответ AI и Processing Theater: данные извлекаются, score меняется, выжимка собирается на глазах.",
      ...
      <section className="mt-8 grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <aside className="grid content-start gap-4 rounded-lg border border-signal/18 bg-white/[0.06] p-5 shadow-[0_32px_120px_rgb(var(--signal-rgb)/0.14)] backdrop-blur-xl">
          ...
          <p className="text-sm leading-6 text-slate-300">
            “Это не production banking system и не обещание approve. Это первая версия продукта, которая показывает, как AI помогает быстрее обработать заявку, не потерять горячего лида, отфильтровать мусор и увидеть качество источников.”
          </p>
