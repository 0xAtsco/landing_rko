...
CONTEXT_RECEIVED_TEXT = "Спасибо, контекст сохранён и передан Игорю. Он посмотрит вашу ситуацию и напишет в Telegram, если текущий формат вам подходит."
...
Автоматически передать его Игорю сейчас не получилось. Заявка остаётся в боте и доступна администраторам."""
